  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-start sm:justify-center p-3 sm:p-4 lg:p-6 overflow-y-auto bg-background min-h-0">
      ...
      <div className="w-full max-w-3xl space-y-4 sm:space-y-6 mt-4 sm:mt-0">
        ...
        {/* Header Card */}
        <Card className="text-center border-2 border-[#be1e2d]/30 shadow-lg bg-gradient-to-br from-rose-50/50 to-white">
          <CardHeader className="pb-4 px-4 sm:px-6 py-4 sm:py-6">
            <CardTitle className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#be1e2d] flex items-center justify-center gap-3 flex-wrap">
              <span className="text-center">Di Động Việt Support Agent</span>
            </CardTitle>
            <CardDescription className="text-base sm:text-lg text-[#be1e2d]/80 mt-2">
            ...
            <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto mt-3 leading-relaxed">
              Tìm kiếm sản phẩm, nhận tư vấn, và quản lý giỏ hàng với AI Assistant của Di Động Việt. 
        ...
        {/* Input Form Card */}
        <Card className="border-2 border-[#be1e2d]/30 shadow-lg bg-gradient-to-br from-rose-50/30 to-white">
        ...
        <div className="flex flex-wrap justify-center gap-2 sm:gap-3 pb-4">
          <Badge variant="outline" className="flex items-center gap-1 text-xs border-[#be1e2d]/40 text-[#be1e2d]">
